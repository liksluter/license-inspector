 ...
 * ограничительных лицензий. Имя таски состоит из префикса `inspectLicensesFor` и имени варианта сборки с заглавной буквы,
 * например: inspectLicensesForDebug. Для настройки плагин создает расширение со следующими параметрами:
